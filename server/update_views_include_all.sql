-- ============================================================
-- ACTUALIZACIÓN DE VISTAS - INCLUIR TODO (CUSTOMS + MATCHMAKING)
-- ============================================================
-- Ejecutar en Supabase SQL Editor para ver todas las partidas
-- ============================================================

-- Vista de estadísticas por jugador (todo)
...
-- Quitamos el filtro: WHERE g.is_matchmaking = false
GROUP BY gamertag
ORDER BY total_score DESC;

-- Vista de partidas recientes (todo)
...
-- Mensaje de éxito
-- SELECT 'Vistas actualizadas para incluir todas las partidas' as status;
